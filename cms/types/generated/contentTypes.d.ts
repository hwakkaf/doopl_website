...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    copyright_company: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'Doopl'>;
    copyrights: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'All Rights Reserved to AFG'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credit_for: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Adonai Freelance Group'>;
    ...
    social_telegram: Schema.Attribute.String;
    social_whatsapp: Schema.Attribute.String;
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['Page link', 'Hash Link', 'Grouping', 'Menu bar']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    siteStatus: Schema.Attribute.Enumeration<['Online', 'Offline']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    underConstructionPage: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSitemapSitemap extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    access: Schema.Attribute.Enumeration<
      ['Dynamic', 'Static', 'Under Construction']
    > &
...
export interface ApiVocabVocab extends Struct.CollectionTypeSchema {
  collectionName: 'vocabs';
  info: {
    description: '';
    displayName: 'Vocab';
    pluralName: 'vocabs';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::vocab.vocab'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
