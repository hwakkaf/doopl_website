...
import {dooplMenu} from '../menu/menu.js'
import {linkMenu} from '../link-menu/link-menu.js'
...
export const footer = data => {
  ...
  <footer class="footer flex-ver-st-ch">
    ...
    <div class="footer-center flex-hor-st-st">
      ${select({data: data.languages, current: 'English (En)', icon: 'languages'})}
      ${select({data: data.cities, current: 'Victoria, Australia', icon: 'cities'})}
    </div>
