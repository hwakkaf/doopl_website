      ...
      <div class="happy-customers-slides f-r">
        ${(happyCustomers.customers || []).map((w,i) => html`
          <div class="happy-customers-card f-c f-j-sa f-a-ce">
            ...
            <p class="mont-400-17--0d2-29px-top n-on-t-color center"><span class="mont-700-18-0-32-top p-color">“ </span>${w.narrative}<span class="mont-700-18-0-32-top p-color"> ”</span></p>
          </div>
        `)}
      </div>
